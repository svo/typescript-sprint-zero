module.exports = {
  forbidden: [
    ...
    {
      name: 'not-to-interfaces-from-infrastructure',
      comment: 'Infrastructure layer should not import from interfaces layer',
      severity: 'error',
      from: { path: '^src/infrastructure' },
      to: { path: '^src/interfaces' },
    },
    {
      name: 'not-to-infrastructure-from-interfaces',
      comment: 'Interfaces layer should not import from infrastructure layer',
      severity: 'error',
      from: { path: '^src/interfaces' },
      to: { path: '^src/infrastructure' },
    },
    {
      name: 'not-to-config-from-domain',
      comment: 'Domain layer should not import from config layer',
      severity: 'error',
      from: { path: '^src/domain' },
      to: { path: '^src/config' },
    },
    {
      name: 'not-to-config-from-application',
      comment: 'Application layer should not import from config layer',
      severity: 'error',
      from: { path: '^src/application' },
      to: { path: '^src/config' },
    },
    {
      name: 'not-to-config-from-infrastructure',
      comment: 'Infrastructure layer should not import from config layer',
      severity: 'error',
      from: { path: '^src/infrastructure' },
      to: { path: '^src/config' },
    },
    {
      name: 'not-to-config-from-interfaces',
      comment: 'Interfaces layer should not import from config layer',
      severity: 'error',
      from: { path: '^src/interfaces' },
      to: { path: '^src/config' },
    },
